...
KEY_WORDS:      some stuff rsh custom  edit with sql model for forms and fields zzzz
CLASS_NAME:     CustomEditWidgetSqlTab
WIDGETS:        CQLineEdit CQDateEdit QSqlTableModel
STATUS:         dev 2/10
TAB_TITLE:      RSHCustom_EditWidgetsSql
...
#  --------
class CustomEditWidgetSqlTab( QWidget ) :
    def __init__(self):
        """
