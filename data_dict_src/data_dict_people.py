...
def build_it( a_data_dict_all ):
    ...
    """
    # ---- people_text ========================================================-
    a_table_dict   = data_dict_all.TableDict(  "people_text" )
    ...
    # ---- people ================================================================
    a_table_dict   = data_dict_all.TableDict( "people" )
    a_data_dict_all.add_table ( a_table_dict )
    ...
    # ---- l_name
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "l_name",
                                             display_order  =  25,
                                             db_type        = "VARCHAR(45)",
                                             display_type   = "string",
                                             max_len        = None,
    ...
    # ---- f_name
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "f_name",
                                             display_order  =  23,
                                             db_type        = "VARCHAR(35)",
                                             display_type   = "string",
                                             max_len        = None,
    ...
    # ---- st_adr_1
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "st_adr_1",
                                             display_order  =  60,
                                             db_type        = "VARCHAR(35)",
                                             display_type   = "string",
                                             max_len        = None,
    ...
    # ---- st_adr_2
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "st_adr_2",
                                             display_order  =  61,
                                             db_type        = "VARCHAR(35)",
                                             display_type   = "string",
                                             max_len        = None,
    ...
    # ---- st_adr_3
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "st_adr_3",
                                             display_order  =  62,
                                             db_type        = "VARCHAR(35)",
                                             display_type   = "string",
                                             max_len        = None,
    ...
    # ---- city
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "city",
                                             display_order  =  70,
                                             db_type        = "VARCHAR(35)",
                                             display_type   = "string",
                                             max_len        = None,
    ...
    # ---- state
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "state",
                                             display_order  =  72,
                                             db_type        = "VARCHAR(25)",
                                             display_type   = "string",
                                             max_len        = None,
    ...
    # ---- zip
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "zip",
                                             display_order  =  74,
                                             db_type        = "VARCHAR(15)",
                                             display_type   = "string",
                                             max_len        = None,
    ...
    # ---- m_name
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "m_name",
                                             display_order  = 24,
                                             db_type        = "VARCHAR(25)",
                                             display_type   = "string",
                                             max_len        = None,
    ...
    # ---- dddd
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "dddd",
                                             db_type        = "VARCHAR(5)",
                                             display_type   = "string",
                                             max_len        = None,
                                             default_func   = None,   )
    ...
    # ---- department
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "department",
                                             db_type        = "VARCHAR(15)",
                                             display_type   = "string",
                                             max_len        = None,
                                             default_func   = None,   )
    ...
    # ---- floor
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "floor",
                                             db_type        = "VARCHAR(15)",
                                             display_type   = "string",
                                             max_len        = None,
                                             default_func   = None,   )
    ...
    # ---- role_text
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "role_text",
                                             db_type        = "VARCHAR(40)",
                                             display_type   = "string",
                                             max_len        = None,
                                             default_func   = None,   )
    ...
    # ---- assoc_msn
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "assoc_msn",
                                             db_type        = "VARCHAR(60)",
                                             display_type   = "string",
                                             max_len        = None,
                                             default_func   = None,   )
    ...
    # ---- bussiness_house
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "bussiness_house",
                                             db_type        = "VARCHAR(40)",
                                             display_type   = "string",
                                             max_len        = None,
                                             default_func   = None,   )
    ...
    # ---- country
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "country",
                                             db_type        = "VARCHAR(40)",
                                             display_type   = "string",
                                             max_len        = None,
                                             default_func   = None,   )
    ...
    # ---- autodial
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "autodial",
                                             db_type        = "INTEGER",
                                             display_type   = "integer",
                                             max_len        = None,
                                             default_func   = None,   )
    ...
    # ---- people_key_word -----------------------------------
    a_table_dict   = data_dict_all.TableDict(  "people_key_word" )
    a_data_dict_all.add_table ( a_table_dict )
    ...
    a_table_dict   = data_dict_all.TableDict(  "people_phone" )
    a_data_dict_all.add_table ( a_table_dict )
    ...
    # ---- "seq_id",
    a_column_dict = data_dict_all.ColumnDict( column_name  = "seq_id",
                                             display_order  =  2,
                                          db_type      = "VARCAR(10)",
                                          display_type = "error",
                                          max_len        = None,
    ...
    # ---- "people_id_old",
    a_column_dict = data_dict_all.ColumnDict( column_name  = "people_id_old",
                                             display_order  =  12,
                                          db_type      = "VARCAR(10)",
                                          display_type = "error",
                                          max_len        = None,
    ...
    # ---- "people_id",
    a_column_dict = data_dict_all.ColumnDict( column_name  = "people_id",
                                             display_order  =  20,
                                             db_type        = "INTEGER",
                                             form_read_only       = True,
                                             rec_to_edit_cnv      = "cnv_int_to_str",
    ...
    # ---- "phone_old",
    a_column_dict = data_dict_all.ColumnDict( column_name  = "phone_old",
                                             display_order  =  40,
                                          db_type      = "VARCAR(35)",
                                          display_type = "error",
                                          max_len        = None,
    ...
    # ---- "phone",
    a_column_dict = data_dict_all.ColumnDict( column_name  = "phone",
                                          db_type      = "VARCAR(100)",
                                          display_type = "error",
                                          max_len        = None,
                                          default_func   = None,
