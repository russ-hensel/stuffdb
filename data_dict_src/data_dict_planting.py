...
def build_it( a_data_dict_all ):
    """
    build the data_dict_all for these tables


    """
    # ---- planting ---------------------------------------------
    a_table_dict   = data_dict_all.TableDict( "planting" )
    ...
    # ---- plant_id_old
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "plant_id_old",
                                             db_type        = "VARCHAR(15)",
                                             display_type   = "string",
                                             max_len        = None,
                                             default_func= None,   )
    ...
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "bed_id_old",
                                             db_type        = "VARCHAR(15)",
                                             display_type   = "string",
                                             max_len        = None,
                                             default_func= None,   )
    ...
    # ---- need_stake
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "need_stake",
                                             db_type        = "INTEGER",
                                             display_type   = "integer",
                                             max_len        = None,
                                             default_func= None,   )
    ...
    # ---- need_label
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "need_label",
                                             db_type        = "INTEGER",
                                             display_type   = "integer",
                                             max_len        = None,
                                             default_func= None,   )
    ...
    # ---- need_work
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "need_work",
                                             db_type        = "INTEGER",
                                             display_type   = "integer",
                                             max_len        = None,
                                             default_func= None,   )
    ...
    # ---- planting_text ---------------------------------------------
    a_table_dict   = data_dict_all.TableDict( "planting_text" )
    a_data_dict_all.add_table ( a_table_dict )
    ...
    # ---- planting_event  ---------------------
    a_table_dict   = data_dict_all.TableDict(  "planting_event" )
    a_data_dict_all.add_table ( a_table_dict )
    ...
    # ---- "planting_id_old",
    a_column_dict = data_dict_all.ColumnDict( column_name  = "planting_id_old",
                                          db_type      = "VARCHAR(15)",
                                          display_type = "error",
                                          max_len        = None,
                                          default_func   = None,   )
    ...
    # ---- "planting_id",
    a_column_dict = data_dict_all.ColumnDict( column_name  = "planting_id",
                                          db_type      = "INTEGER",
                                             form_read_only       = True,
                                           rec_to_edit_cnv      = "cnv_int_to_str",
                                           dict_to_edit_cnv     = "cnv_int_to_str",
    ...
    # ---- "dt_mo",
    a_column_dict = data_dict_all.ColumnDict( column_name  = "dt_mo",
                                          db_type      = "INTEGER",
                                          display_type = "integer",
                                          max_len        = None,
                                          default_func   = None,   )
    ...
    # ---- "dt_day",
    a_column_dict = data_dict_all.ColumnDict( column_name  = "dt_day",
                                          db_type      = "INTEGER",
                                          display_type = "integer",
                                          max_len        = None,
                                          default_func   = None,   )
    ...
    # ---- "day_of_year",
    a_column_dict = data_dict_all.ColumnDict( column_name  = "day_of_year",
                                          db_type      = "INTEGER",
                                          display_type = "integer",
                                          max_len        = None,
                                          default_func   = None,   )
    ...
    a_table_dict   = data_dict_all.TableDict( "planting_key_word" )
    a_data_dict_all.add_table ( a_table_dict )
