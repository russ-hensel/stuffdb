...
def build_it( a_data_dict_all ):
    ...
    """
    # ---- photoshow ---------------------------------------------
    a_table_dict   = data_dict_all.TableDict( "photoshow" )
    ...
    # ---- start_date
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "start_date",
                                             db_type        = "INTEGER",
                                             #form_read_only       = True,
    ...
    # ---- end_date
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "end_date",
                                             db_type        = "INTEGER",
                                             #form_read_only       = True,
                                             rec_to_edit_cnv      = "cnv_int_to_qdate",
                                             dict_to_edit_cnv     = "cnv_int_to_qdate",
    ...
    # ---- create_date
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "create_date",
                                             db_type        = "INTEGER",
                                             #form_read_only       = True,
                                             rec_to_edit_cnv      = "cnv_int_to_qdate",
                                             dict_to_edit_cnv     = "cnv_int_to_qdate",
    ...
    # ---- web_site_dir
    a_column_dict = data_dict_all.ColumnDict(    column_name    = "web_site_dir",
                                             db_type        = "VARCHAR(240)",
                                             display_type   = "string",
                                             max_len        = None,
                                             default_func   = None,   )
    ...
    # ---- photoshow_text ---------------------
    a_table_dict   = data_dict_all.TableDict(  "photoshow_text" )
    a_data_dict_all.add_table ( a_table_dict )
    ...
    # ---- photoshow_key_word ---------------------------------------------
    a_table_dict   = data_dict_all.TableDict( "photoshow_key_word" )
    a_data_dict_all.add_table ( a_table_dict )
