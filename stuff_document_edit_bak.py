...
class EditStuffEvents( QDialog ):
    ...
    def __init__(self, model, index,  parent = None):
        ...
        self.parent_window  = parent
            ...
            # watch for it
        self.model          = model   # think this is model on caller
    ...
    def update_db(self):
        ...
        debug_msg    = "EditStuffEvents, update_db may be doing update change this may want in tab"
        logging.log( LOG_LEVEL,  debug_msg, )
        #self.fields_to_model()
        #ia_qt.q_sql_table_model( self.model, msg = debug_msg,    )
    ...
    def fields_to_model( self, ):
        ...
        debug_msg   = "fields_to_model done"
        logging.log( LOG_LEVEL,  debug_msg, )
    ...
    def fields_to_model_1(self, ):
        ...
        if not self.index:   # new row  self.index and index not the same
            print( "fields_to_model_1 ***********>new row AppGlobal.key_gen       = a_key_gen")
            ...
            debug_msg   = ( "fields_to_model_1-****************.update not sure why this message ")
            logging.log( LOG_LEVEL,  debug_msg, )
        ...
        debug_msg   = ( f"fields_to_model stuff_id  {data} {self.stuff_id_ix = }")
        logging.log( LOG_LEVEL,  debug_msg, )
        ...
        debug_msg   = ( f"fields_to_model cmnt  {data} {self.cmnt_ix = }")
        logging.log( LOG_LEVEL,  debug_msg, )

        model.setData( model.index(  ix_row, self.cmnt_ix ), data )  #cannot debug into
        ...
        debug_msg   = ( f"fields_to_model dlr  {data} {self.dlr_ix = }")
        logging.log( LOG_LEVEL,  debug_msg, )
        ...
        debug_msg   = ( f"fields_to_model type  {data} {self.type_ix = }")
        logging.log( LOG_LEVEL,  debug_msg, )
