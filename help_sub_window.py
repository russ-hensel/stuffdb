...
# -*- coding: utf-8 -*-
"""
this is a new help_sub_window built out of the stuff one, to retire
the version that really used the channel table
is 4:11 july26  how long till something runs
...
# ----------------------------------------
class HelpSubWindow( stuffdb_tabbed_sub_window.StuffdbTabbedSubWindow ):
    """
    for the stuff table....
    """
    def __init__(self,  ):
    ...
    def build_tab_list( self, parent_window   ):
        ...
        what it says, read
        """
        return HelpListTab( parent_window )
    ...
    def build_tab_criteria( self,   parent_window ):
        ...
        """
        return HelpCriteriaTab( parent_window  )
    ...
    def build_tab_detail( self, parent_window ):
        ...
        'build_tab_detail'
        """
        return HelpDetailTab(  parent_window )
    ...
    def build_tab_text( self, parent_window ):
        ...
        'build_tab_detail'
        """
        return HelpTextTab(  parent_window )
    ...
    def build_tab_history( self,   parent_window ):
        ...
        what it says, read
        """
        return HelpHistorylTab( parent_window )
...
class HelpCriteriaTab( QWidget, ):
    ...
    def build_tab( self,   ):
        ...
        # ---- Channel Like
        a_widget  = QLabel( "Help Key Words" )
        placer.new_row()
...
# ----------------------------------------
class HelpListTab( stuffdb_tabbed_sub_window.StuffdbTab  ):
...
# ----------------------------------------
class HelpDetailTab( stuffdb_tabbed_sub_window.StuffdbTab  ):
    """
    """
    def __init__(self, parent_window  ):
        """
    ...
    def _build_gui( self ):
        ...
        a_field           = QLineEdit()
        self.title_field  = a_field
        a_field.setPlaceholderText( "title" )
        tab_layout.addWidget( a_field )
        ...
        # tab_layout.addWidget( self.title_field )
        ...
        self.id_field_fake       = field_widget
        field_widget.setValidator( QIntValidator() )
        field_widget.setPlaceholderText("Enter ID fake")
        tab_layout.addWidget(self.id_field)

        entry_widget               = QTextEdit()
        self.text_data_field_fake  = entry_widget
    ...
    def field_to_record( self, record ):
        ...
        record.setValue( "title",      self.title_field.text())
...
# self.add_kw_field.clear()
        ...
        self.title_field.setText(     record.value(    "title"       ))
...
# ----------------------------------------
class TestDetaiSubTabxxxxxxx( QWidget,    ):
...
# ----------------------------------------
class HelpHistorylTab( stuffdb_tabbed_sub_window.StuffdbTab  ):
...
# ==================================
class HelpTextTab( stuffdb_tabbed_sub_window.StuffdbTab  ):
    ...
    def _create_gui( self ):
        """
        just here to maintain the code model
        fields are created on the detail tab
        Returns:
            none
        """
    ...
    #self.fake_gui( a_foreign_layout )
    #-------------------------------------
    def fake_gui( self, a_foreign_subwindow ):
        """
        lets assume the gui is really build
        by the detail tab so do not do anything here
        but capture the field names in
