...
from
        ...
        not sure what this does, may make points for a gpx_map not make one

        PROBABLY NOT USED OR USEFUL LOOK IN GEO TRACK, TEST DELETE
...
class GpxMap( ):
    ...
    def __init__( self,   ):
        ...
        self.routesFolder  = './output'  # rlative to where
        self.map_html      = None

    # ---------------------
    def make_map( self, point_list ):
        """
