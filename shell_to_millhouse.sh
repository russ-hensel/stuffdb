...
# Run rsync using the variable
rsync -u -t --progress \
  /mnt/WIN_D/russ/0000/python00/python3/_projects/stuffdb/docs/*.* \
  "$TARGET_BASE/docs"
...
rsync -u -t --progress \
  /mnt/WIN_D/russ/0000/python00/python3/_projects/stuffdb/sql/*.* \
                                            "$TARGET_BASE/sql"

rsync -u -t --progress \
  /mnt/WIN_D/russ/0000/python00/python3/_projects/stuffdb/misc/*.* \
                                            "$TARGET_BASE/misc"

rsync -u -t --progress \
  /mnt/WIN_D/russ/0000/python00/python3/_projects/stuffdb/data_dict_src/*.* \
                                            "$TARGET_BASE/data_dict_src"

rsync -u -t --progress \
  /mnt/WIN_D/russ/0000/python00/python3/_projects/stuffdb/py_helpers/*.* \
                                            "$TARGET_BASE/py_helpers"

rsync -u -t --progress \
  /mnt/WIN_D/russ/0000/python00/python3/_projects/stuffdb/data/*.* \
                                            "$TARGET_BASE/data"


#-------------------------
rsync -u -t --progress \
  /mnt/WIN_D/russ/0000/python00/python3/_projects/stuffdb/data/russ2025/*.* \
                                            "$TARGET_BASE/data/russ2025"


#-------------

#rsync -u -t -progress       /mnt/WIN_D/russ/0000/python00/python3/_projects/stuffdb/*.*                   /mnt/millhouse/rsync/_projects/stuffdb
...
rsync -u -t --progress \
  /mnt/WIN_D/russ/0000/python00/python3/_projects/rshlib/in_spect/*.* \
                                           "$TARGET_BASE/in_spect"

rsync -u -t --progress \
  /mnt/WIN_D/russ/0000/python00/python3/_projects/rshlib/app_services/*.* \
                                           "$TARGET_BASE/app_services"

#rsync -u -t --progress \
#  /mnt/WIN_D/russ/0000/python00/python3/_projects/rshlib/string_util/*.* \             part of app services
#                                           "$TARGET_BASE/string_util"

rsync -u -t --progress \
  /mnt/WIN_D/russ/0000/python00/python3/_projects/rshlib/os_call/*.* \
                                           "$TARGET_BASE/os_call"
