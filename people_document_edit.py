...
#--------------------------------------------
class EditPeopleEvents( QDialog ):
    """
    what it says, read?
...
class EditPeopleContact( QDialog ):
    ...
    def __init__(self, model, index,  parent = None):
        ...
        if index:
            msg    = "Edit Contact Info"
        else:
            msg    = "Add Contact Info"
    ...
    def fields_to_model(self, ):
        ...
        ia_qt.q_sql_table_model( model, "post fields_to_model" )